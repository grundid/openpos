...
public class JTicketsBagTicket extends JTicketsBag {
    ...
    private static final String PRINTER_TICKET_PREVIEW = "Printer.TicketBackup";
    ...
    private void printTicket() {
        ...
        if (m_ticket == null) {
            ...
            try {
                ...
                m_TTP.printTicket(script.eval(m_dlSystem.getResourceAsXML(PRINTER_TICKET_PREVIEW)).toString());
    ...
    private void m_jPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jPrintActionPerformed
        ...
        if (m_ticket != null) {
            try {
                ScriptEngine script = ScriptFactory.getScriptEngine(ScriptFactory.VELOCITY);
                script.put("ticket", m_ticket);
                m_TTP2.printTicket(script.eval(m_dlSystem.getResourceAsXML(PRINTER_TICKET_PREVIEW)).toString());
            } catch (ScriptException e) {
